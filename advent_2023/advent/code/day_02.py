from advent_2023.advent.utilities import get_keywords_from_string, get_digit_from_string
import numpy as np
...
def parse_input(item):
    ...
    colors = get_keywords_from_string(item_split[1], ['blue', 'red', 'green'])
...
if __name__ == '__main__':
    ...
    print('Part 2 Answer: ', part_two(inputs))  # 62241
